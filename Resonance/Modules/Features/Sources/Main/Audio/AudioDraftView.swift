...
struct AudioDraftView: View {
    ...
    private static let audioControlHeight: CGFloat = 64
    private static let audioActionSize: CGFloat = 44
    ...
    private var recordButton: some View {
        Button {
            ...
            Label("Записать аудио", systemImage: "mic.fill")
                ...
                .frame(height: Self.audioControlHeight)
        }
        ...
        HStack(spacing: 16) {
            ...
            Button {
                ...
                Image(systemName: "stop.fill")
                    ...
                    .frame(width: Self.audioActionSize, height: Self.audioActionSize)
