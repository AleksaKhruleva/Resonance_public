...
final class AudioPlayer {
    ...
    private var displayLinkObserver: AudioPlayerDisplayLinkObserver?
    ...
    private func startProgressUpdates() {
        ...
        let observer = AudioPlayerDisplayLinkObserver { [weak self] in
        ...
        let displayLink = CADisplayLink(
            target: observer,
            selector: #selector(AudioPlayerDisplayLinkObserver.tick)
        )
        displayLink.add(to: .main, forMode: .common)

        displayLinkObserver = observer
...
private final class AudioPlayerDisplayLinkObserver: NSObject {
